/*
* Nom de fichier : liste.c
* Objectifs : Coder deux fonctions utilisables dans main.c :
*             l'une sert à ajouter une nouvelle couleur dans une liste de couleurs ;
*             l'autre sert à parcourir et à afficher chaque couleur de la liste.
